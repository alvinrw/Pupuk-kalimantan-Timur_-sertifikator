        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 font-sans-clean">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm overflow-hidden border border-slate-200 animate-in zoom-in-95 duration-200">
            <div className="p-5 text-center space-y-3">
              ...
              <h4 className="font-bold text-base text-slate-900">Tandai Sebagai Nonaktif?</h4>
              <p className="text-xs text-slate-600 font-medium pb-2">
                Apakah Anda yakin ingin menandai <br /><strong className="text-slate-800">{activeItemForAction.merekItem}</strong> sebagai Nonaktif?<br />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4 font-sans-clean">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-sm overflow-hidden border border-slate-200 animate-in zoom-in-95 duration-200">
            <div className="p-5 text-center space-y-3">
              ...
              <p className="text-xs text-slate-600 font-medium pb-2">
                Apakah Anda yakin ingin mengaktifkan kembali <br /><strong className="text-slate-800">{activeItemForAction.merekItem}</strong>?<br />
