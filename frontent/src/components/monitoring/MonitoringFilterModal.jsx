...
export default function MonitoringFilterModal({
  isOpen,
  onClose,
  filterKategori,
  setFilterKategori,
  filterUnitPabrik,
  setFilterUnitPabrik,
  filterStatusOperasional,
  setFilterStatusOperasional,
  filterRentangHari,
  setFilterRentangHari,
  allCertificates,
  uniqueUnitPabrik,
  customUrgentDays,
  filteredCertificatesCount,
  resetFilters
}) {
        ...
        <div className="p-6 space-y-4 text-xs font-mono-data">
          ...
          <div className="p-3 bg-blue-50/70 border border-blue-200 rounded-xl text-slate-700 flex items-center justify-between">
            ...
            <span className="text-xs font-extrabold text-[#005ea4] bg-white px-2.5 py-1 rounded-lg border border-blue-200">
              {filteredCertificatesCount} of {allCertificates.length} items
            </span>
          </div>
        </div>
